...
'<text x="160" y="59" font-size="18" fill="#fff" text-anchor="middle" style="font-family: \'Roboto\';font-weight: 700;">GM! You are ', _message,'!!</text>',
...
'<rect x="80" y="170" width="90" height="10" class="body-fill" /><rect x="180" y="170" width="10" height="10" class="body-fill" /><rect x="200" y="170" width="10" height="10" class="body-fill" /><rect x="80" y="180" width="90" height="10" class="body-fill" /><rect x="180" y="180" width="10" height="10" class="body-fill" /><rect x="70" y="190" width="40" height="10" class="body-fill" /><rect x="130" y="190" width="50" height="10" class="body-fill" /><rect x="80" y="200" width="30" height="10" class="body-fill" /><rect x="150" y="200" width="30" height="10" class="body-fill" /><rect x="90" y="210" width="40" height="10" class="body-fill" /><rect x="140" y="210" width="30" height="10" class="body-fill" /><rect x="80" y="220" width="110" height="10" class="body-fill" /><rect x="100" y="230" width="50" height="10" class="body-fill" /><rect x="160" y="230" width="20" height="10" class="body-fill" /><rect x="100" y="240" width="40" height="10" class="body-fill" /><rect x="150" y="240" width="40" height="10" class="body-fill" /><rect x="90" y="250" width="10" height="10" class="body-fill" /><rect x="110" y="250" width="40" height="10" class="body-fill" /><rect x="160" y="250" width="30" height="10" class="body-fill" /><rect x="130" y="260" width="50" height="10" class="body-fill" /><rect x="160" y="270" width="10" height="10" class="body-fill" /><rect x="150" y="280" width="30" height="10" class="body-fill" /></svg>'
    ...
    function _getMessageAndColors(
        ...
        if (kind == 0) {
            return ("GREAT", ["FAFAFA", "A736FF", "DCDCDC"]);
        } else if (kind == 1) {
            return ("AWESOME", ["00AEEF", "FFD700", "FF0000"]);
        } else if (kind == 2) {
            return ("WONDERFUL", ["FFD1A4", "A736FF", "DCDCDC"]);
        } else if (kind == 3) {
            return ("INCREDIBLE", ["A9A9A9", "2E8B57", "8B4513"]);
        } else if (kind == 4) {
            return ("SUPER", ["FF0000", "0000FF", "DCDCDC"]);
        } else if (kind == 5) {
            return ("DOPE", ["0000FF", "FFFF00", "DCDCDC"]);
        } else if (kind == 6) {
            return ("COOL", ["FFA500", "010101", "FFA500"]);
        } else if (kind == 7) {
            return ("PERFECT", ["0A5C62", "FF0000", "DCDCDC"]);
        } else if (kind == 8) {
            return ("SICK", ["8B4513", "FFFFFF", "FFC0CB"]);
        } else if (kind == 9) {
            return ("SWEET", ["20DA1D", "D1FF1B", "DCDCDC"]);
        } else if (kind == 10) {
            return ("EPIC", ["FFA6A6", "8F00FF", "DCDCDC"]);
        } else if (kind == 11) {
            return ("INSANE", ["625FFF", "A736FF", "DCDCDC"]);
        } else if (kind == 12) {
            return ("FANTASTIC", ["A5A5A5", "A736FF", "DCDCDC"]);
        } else if (kind == 13) {
            return ("INCREDIBLE", ["FFC940", "ECD4FF", "DCDCDC"]);
        } else if (kind == 14) {
            return ("EXCELLENT", ["EF0DE6", "52FF36", "DCDCDC"]);
        } else if (kind == 15) {
            return ("MARVELOUS", ["BDFF00", "A736FF", "DCDCDC"]);
        } else if (kind == 16) {
            return ("FABULOUS", ["008124", "8F00FF", "DCDCDC"]);
        } else if (kind == 17) {
            return ("BRILLIANT", ["000000", "52FF36", "DCDCDC"]);
        } else if (kind == 18) {
            return ("OUTSTANDING", ["747474", "FF3636", "DCDCDC"]);
        } else if (kind == 19) {
            return ("REMARKABLE", ["FF2674", "FDC3BF", "DCDCDC"]);
        } else if (kind == 20) {
            return ("IMPRESSIVE", ["E5E540", "434343", "B8280B"]);
        }
        return ("", ["", "", ""]);
    }
